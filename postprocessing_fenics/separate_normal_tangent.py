...
"""
Based on the displacement field, separate the normal and tangential components of the displacement field
Problem is that surface normal is changing with time, so we need to compute the surface normal at each time step
"""
...
def compute_volume(case_path, mesh_name, dt, stride, save_deg):
    ...
    # Create higher-order function space for d
